...
vec2.fromVec = function(v){
  if (Object.prototype.toString.call(v) === '[object Array]'){
    ...
    switch(v){
      ...
      case 'topright':    return new vec2(util.invSqrtTwo, -util.invSqrtTwo)
      case 'right':       return new vec2(1, 0)
      case 'bottomright': return new vec2(util.invSqrtTwo, util.invSqrtTwo)
      case 'bottom':      return new vec2(0, 1)
      case 'bottomleft':  return new vec2(-util.invSqrtTwo, util.invSqrtTwo)
      case 'left':        return new vec2(-1, 0)
      case 'topleft':     return new vec2(-util.invSqrtTwo, -util.invSqrtTwo)
...
vec2.prototype.toString = function(sep){
  sep = (sep === undefined) ? ' ' : sep
  return this.x.toString() + sep + this.y.toString()
}
